...
public class AnpvizConfig extends SensorConfig {
	...
	public AnpvizConfig() throws IOException {
		// default params for Anpviz
	...
	public void init() throws IOException {
		/****************** Add PTZ Presets ******************/
		AnpvizPTZpreset home = new AnpvizPTZpreset();
		home.name = "Reset";
		home.cgi = "ptzReset";
		ptz.presets.add(home);

		AnpvizPTZpreset point0 = new AnpvizPTZpreset();
		AnpvizPTZpreset point1 = new AnpvizPTZpreset();
		AnpvizPTZpreset point2 = new AnpvizPTZpreset();
		AnpvizPTZpreset point3 = new AnpvizPTZpreset();
		AnpvizPTZpreset point4 = new AnpvizPTZpreset();
		AnpvizPTZpreset point5 = new AnpvizPTZpreset();
		AnpvizPTZpreset point6 = new AnpvizPTZpreset();
		AnpvizPTZpreset point7 = new AnpvizPTZpreset();
		AnpvizPTZpreset point8 = new AnpvizPTZpreset();
		AnpvizPTZpreset point9 = new AnpvizPTZpreset();
		AnpvizPTZpreset point10 = new AnpvizPTZpreset();
		AnpvizPTZpreset point11 = new AnpvizPTZpreset();
		AnpvizPTZpreset point12 = new AnpvizPTZpreset();
		AnpvizPTZpreset point13 = new AnpvizPTZpreset();
		AnpvizPTZpreset point14 = new AnpvizPTZpreset();
		AnpvizPTZpreset point15 = new AnpvizPTZpreset();
		/****************************************************/
		...
		AnpvizPTZrelMove BottomRight = new AnpvizPTZrelMove();
