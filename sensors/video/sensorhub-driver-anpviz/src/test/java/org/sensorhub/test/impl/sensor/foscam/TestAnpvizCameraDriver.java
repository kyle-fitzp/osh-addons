...
import org.sensorhub.impl.sensor.foscam.AnpvizConfig.ResolutionEnum;
...
public class TestFoscamCameraDriver implements IEventListener {
	...
	FoscamDriver driver;
	org.sensorhub.impl.sensor.foscam.AnpvizConfig config;
	int sampleCount = 0;

	@Before
	public void init() throws Exception {
		config = new org.sensorhub.impl.sensor.foscam.AnpvizConfig();
